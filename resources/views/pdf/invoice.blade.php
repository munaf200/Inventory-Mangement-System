...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .logo-circle {
            display: inline-block; border: 1.5px solid #9c6b1f; border-radius: 50%;
            width: 78px; height: 78px; text-align: center; line-height: 78px;
        ...
        .logo-name {
            ...
            text-transform: uppercase; margin-top: 8px; color: #111111;
        }
        .logo-tagline {
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <table class="bottom-section">
        <tr>
            ...
            <td style="width: 40%;">
                <div class="signature-text">{{ $company['signature'] ?? 'Haroon' }}</div>
